...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="falcon-7b")
    ...
    save_path = f'outputs/model_outputs/{model_name}_{dataset_name}_with_no_hint.jsonl'
    ...
    for data in datas:
        ...
        model_input = \
f"""Generate reasoning for question.
...
Reasoning:"""
        ...
        # model_input = "lzq is a ?"
        # input("Press Enter to continue...")
        # data["model_output"] = get_messages(model_input, url, model_name, max_new_tokens=5)
