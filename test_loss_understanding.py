...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="codellama-7b-instruct")
    ...
    save_path = f'outputs/loss/{model_name}_{dataset_name}_understanding.jsonl'
    ...
    for data in datas:
        ...
        instruction = f"Understand the question.\nQuestion:\n"
        text = instruction + data['question']
