...
if __name__ == "__main__":
    ...
    save_path = f'outputs/model_outputs/{model_name}_{dataset_name}_with_factual_hint.jsonl'
    ...
    for data in datas:
        ...
        hint0 = examples[0]["factual-hint"]
        random.shuffle(hint0)
        hint0 = '\n'.join(hint0)
        
        hint1 = examples[1]["factual-hint"]
        random.shuffle(hint1)
        hint1 = '\n'.join(hint1)
        
        hint = data["factual-hint"]
        random.shuffle(hint) 
        hint = '\n'.join(hint)
