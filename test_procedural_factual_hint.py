...
if __name__ == "__main__":
    ...
    save_path = f'outputs/model_outputs/{model_name}_{dataset_name}_with_procedural_factual_hint.jsonl'
    ...
    for data in datas:
        ...
        f_hint0 = examples[0]["factual-hint"]
        random.shuffle(f_hint0)
        f_hint0 = '\n'.join(f_hint0)
        
        f_hint1 = examples[1]["factual-hint"]
        random.shuffle(f_hint1)
        f_hint1 = '\n'.join(f_hint1)
        
        f_hint = data["factual-hint"]
